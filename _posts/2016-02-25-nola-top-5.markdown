...
date: 2016-02-25
categories:
  - destination nola mardigras food southern
description: 
...
<ul>
  <li>Peche</li>
  <li>Ace Hotel (particularly the rooftop)</li>
  <li>Cane and Table</li>
  <li>Shaya</li>
  <li>Bacchanal</li>
</ul>
...
<h4>Ace Hotel (particularly the rooftop)</h4>
...
<figure>
  <img src="/assets/images/bacchanal.jpg" alt="Placeholder"/>
